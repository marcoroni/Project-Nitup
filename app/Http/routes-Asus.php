...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::get('/winkelwagen/payment/request', [
        'middleware' => 'auth',
        'uses' => 'ProductController@PaymentRequest'
    ]);
    ...
    Route::post('/product/toevoegen/request', [
        'middleware' => 'auth',
    ...
    Route::get('/games?php{search}', 'DashboardController@IndexSearch');
